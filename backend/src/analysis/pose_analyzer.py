...
class PoseAnalyzer:
    def __init__(self):
        ...
        # Set up directories using environment variables with fallback to base_dir
        self.data_dir = os.getenv("SHOT_DATA_DIR", str(base_dir / "data" / "shot_data"))
        self.reference_dir = os.getenv("REFERENCE_SHOTS_DIR", str(base_dir / "data" / "reference" / "reference_shots"))
        self.user_dir = os.getenv("USER_SHOTS_DIR", str(base_dir / "data" / "raw" / "users_shots"))
